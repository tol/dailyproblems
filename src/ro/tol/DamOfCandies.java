 ...
 * Help him select 2 books such that he can store maximum candies between them by removing all the other books
 * from between the selected books. The task is to find out the area between
 * two books that can hold the maximum candies without changing the original position of selected books.
 *
 *
 * Example 1:
 *
